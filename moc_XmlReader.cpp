...
struct qt_meta_stringdata_XmlReader_t {
    QByteArrayData data[3];
    char stringdata[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_XmlReader_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_XmlReader_t qt_meta_stringdata_XmlReader = {
    {
QT_MOC_LITERAL(0, 0, 9),
QT_MOC_LITERAL(1, 10, 9),
QT_MOC_LITERAL(2, 20, 0)
    },
    "XmlReader\0completed\0\0"
};
...
void XmlReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (XmlReader::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XmlReader::completed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject XmlReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_XmlReader.data,
      qt_meta_data_XmlReader,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_XmlReader.stringdata))
